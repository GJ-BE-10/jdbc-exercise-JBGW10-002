...
class BasicConnectionPoolTest {
    ...
    static void setUp() {
        ...
        basicConnectionPool = new BasicConnectionPool(com.mysql.cj.jdbc.Driver.class.getName(),"jdbc:mysql://10.116.64.14:13306/nhn_academy_2","nhn_academy_2","09EQaSt6Xvb?P?1h",5);
    }
